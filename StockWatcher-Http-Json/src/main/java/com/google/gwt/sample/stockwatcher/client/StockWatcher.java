...
//    private static final String JSON_URL = GWT.getModuleBaseURL() + "qq?q=";
            ...
            Request request = builder.sendRequest(null, new RequestCallback() {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (200 == response.getStatusCode()) {
                        JsArray<StockData> stockDataJsArray = JsonUtils.<JsArray<StockData>>safeEval(response.getText());
                        updateTable(stockDataJsArray);
                    } else {
     ...
     */
    private void updateTable(StockData stockData) {
